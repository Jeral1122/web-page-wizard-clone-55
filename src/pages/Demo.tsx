      ...
      <div className="pt-20 sm:pt-24 pb-12 sm:pb-20 responsive-padding">
        <div className="responsive-container">
          <div className="text-center">
            ...
            <div className="animate-fade-in mb-12 sm:mb-20">
              <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-transparent rounded-full flex items-center justify-center mb-6 sm:mb-8 mx-auto animate-pulse-slow">
                <Phone className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-cyan-400" />
              </div>
              
              <h1 className="responsive-heading font-bold bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent mb-4 sm:mb-6">
                Demo Coming Soon
              </h1>
              
              <p className="responsive-text text-gray-300 mb-8 sm:mb-12 max-w-2xl mx-auto">
            ...
            <section id="faq" className="py-12 sm:py-20">
              <div className="responsive-container">
                <div className="text-center mb-12 sm:mb-16 animate-fade-in">
                  <h2 className="responsive-heading font-bold gradient-text mb-4 sm:mb-6">
                    Common Questions
                  </h2>
                ...
                <div className="text-center animate-fade-in mt-12 sm:mt-16" style={{ animationDelay: '0.4s' }}>
